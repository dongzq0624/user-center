...
//系统权限
export function myHasPermission(permissionId) {
  ...
  // console.log('权限', permissionId)
  return hasPermission
}
//项目权限
export function projectPermission(permissionId) {
  // console.log(permissionId)
  let permissionIds = store.getters['acl/projectPermission']
  let hasPermission = false
  permissionIds.forEach((id) => {
    if (id == permissionId) {
      hasPermission = true
